...
You can also read the code of others games (see [Examples](examples/examples-1-tictactoe.md)). More advanced documentation is available in the [Core concepts](core-concepts/core-1-game-runner.md) section.
